...
def latchCommand():
    ...
    time2 = now2.strftime("%H:%M:%S:%f")
    time1 = now1.strftime("%H:%M:%S:%f")
    writeTime("Pre Latch Command sent at : ", time1)
    writeTime("Post Latch Command sent at : ", time2)
    writeTime("Time Delta in ms: ", str(delta*10**(3)))
...
def unlatchCommand():
    ...
    writeTime("UnLatch Command sent at : ", time)
